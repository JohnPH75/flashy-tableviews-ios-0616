...
//  flashyTableviews
//
//  Created by John Hussain on 7/1/16.
...
- (void)viewDidLoad {
    ...
    self.tableViewArray = [@[@"1", @"2", @"3"] mutableCopy];
    
    
    [self.tableView addParallaxWithImage:[UIImage imageNamed:@"anything.jpg"] andHeight:160];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDate *dateObject = self.tableViewArray[indexPath.row];
...
- (void)swipeableTableViewCell:(SWTableViewCell *)cell didTriggerRightUtilityButtonWithIndex:(NSInteger)index {
    switch (index) {
        ...
        case 1:
        {
            ...
            [self.tableViewArray removeObjectAtIndex:cellIndexPath.row];
